...
<details>
    ...
    example.pdf.aux,  example.pdf.log,  example.pdf.pdf,  main.tex
</details>

<details>
    <summary>How do you change the name of the pdf-file?</summary>
    Den Namen der Pdf ändert man, indem man in dem Befehl den jobname, in den gewünschten Namen ändert.
</details>
...
<details>
    ...
    Die PDF bekommt eine zweite Seite. Auf der ersten seite steht der Titel, der Autor und das Datum. Auf der zweiten Seite steht der Text.
</details>
<details>
    <summary>What changes in your pdf, if you add <code>\section{Intro}</code> after <code>\maketitle</code></summary>
    Wird section eingefügt, entsteht ein "Kapitel" genannt Intro
</details>
